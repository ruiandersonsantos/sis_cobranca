...
class EstadoList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $pais_id = new TDBUniqueSearch('pais_id', 'bd_cobranca', 'Pais', 'id', 'descricao','id asc'  );

        $descricao->addValidation('Descrção', new TRequiredValidator()); 
        $sigla->addValidation('sigla', new TRequiredValidator()); 
        $pais_id->addValidation('pais', new TRequiredValidator()); 

        $pais_id->setMinLength(2);
        $pais_id->setMask('{descricao}');
        $id->setSize(100);
        $sigla->setSize('10%');
        $pais_id->setSize('40%');
        $descricao->setSize('40%');
        ...
        $row4 = $this->form->addFields([new TLabel('Pais:', null, '14px', null)],[$pais_id]);
        ...
        $column_pais_descricao = new TDataGridColumn('pais->descricao', 'Pais ', 'left');
        ...
        $this->datagrid->addColumn($column_pais_descricao);
        ...
        $container->add(TBreadCrumb::create(['Cadastros Iniciais','Estados']));
