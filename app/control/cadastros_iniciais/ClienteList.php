...
class ClienteList extends TPage
{
    ...
    public function __construct()
    {
        ...
        $razao->setSize('30%');
        $codigo->setSize('30%');
        $documento->setSize('30%');
        $nome_fantasia->setSize('30%');
        ...
        $btn_onshow = $this->form->addAction('Cadastrar', new TAction(['ClienteForm', 'onShow']), 'fa:plus #69aa46');
        ...
        $container->add(TBreadCrumb::create(['Cadastros Iniciais','Clientes']));
